...
export function Hero() {
  ...
  return (
    <section ref={ref} className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      {/* aurora bg */}
      <motion.div style={{ x: sx, y: sy }} className="absolute inset-0 -z-10 opacity-70">
        ...
        <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-14 xl:gap-20 items-center">
          ...
          <div className="text-left">
            ...
            >
              ...
              Official <span className="text-gradient font-semibold">Genesys Premier Partner</span>
            ...
            >
              Transforming <span className="text-gradient">Customer Experience</span>
              <br className="hidden md:block" /> through AI, Cloud &amp; Contact Center innovation.
            </motion.h1>
            ...
            >
              Genesys Premier Partner helping enterprises modernize CCaaS, UCaaS, AI, Cloud, CRM and
              Customer Experience ecosystems - end-to-end.
            </motion.p>
        ...
        >
          {[
            ...
            <div key={l} className="bg-[#0E1424]/90 px-6 py-6 text-left">
              <div className="text-2xl md:text-3xl font-semibold text-gradient">{n}</div>
    ...
    <div className="absolute inset-0 grid place-items-center">
              ...
              >
                ...
                >
                  <div className="flex flex-col items-center justify-center gap-1">
                    <Icon size={17} className="text-[#1B75FF] group-hover:text-white transition" />
      ...
      <div className="relative h-36 w-36 md:h-44 md:w-44 rounded-full bg-aurora grid place-items-center shadow-glow z-10">
        ...
        <div className="relative text-center">
          <div className="text-[9px] md:text-[10px] tracking-widest text-white/70">RACUBE</div>
          <div className="text-xl md:text-2xl font-black text-white">CX OS</div>
          <div className="text-[9px] md:text-[10px] tracking-widest text-white/70">PLATFORM</div>
        </div>
      </div>
    </div>
  );
      ...
      <div className="relative overflow-hidden [mask-image:linear-gradient(90deg,transparent,#000_15%,#000_85%,transparent)]">
        <div className="flex gap-12 animate-marquee whitespace-nowrap">
          {row.map((t, i) => (
            <div
              key={i}
              className="flex items-center gap-3 text-base md:text-lg font-medium text-muted-foreground hover:text-foreground transition"
            >
...
export function WhoWeAre() {
  const items = [
    {
      icon: Cloud,
      t: "Cloud Transformation",
      d: "End-to-end cloud migration & modernization across AWS, Azure & GCP.",
    },
    {
      icon: Headphones,
      t: "Contact Center Modernization",
      d: "From legacy IVR to cloud-native omnichannel CX with Genesys.",
    },
    {
      icon: Bot,
      t: "AI-Powered CX",
      d: "Conversational AI, agent assist & speech analytics that scale.",
    },
    {
      icon: Network,
      t: "Enterprise Architecture",
      d: "Reference architectures designed for security, scale & cost.",
    },
    {
      icon: Globe2,
      t: "Global Delivery",
      d: "Distributed engineering pods serving Fortune 1000 enterprises.",
    },
    {
      icon: Workflow,
      t: "DevOps Excellence",
      d: "CI/CD, IaC, observability - engineered for change velocity.",
    },
  ];
  return (
    <SectionShell
      id="about"
      eyebrow="Who we are"
      title="An enterprise CX engineering company built for the AI era."
    >
  ...
  const sols = [
    {
      icon: Headphones,
      t: "Genesys Cloud",
      d: "Premier partner-led design, deployment & optimization for Genesys Cloud CX.",
    },
    {
      icon: Phone,
      t: "CCaaS Transformation",
      d: "Migrate legacy contact centers to modern cloud-native CCaaS platforms.",
    },
    {
      icon: MessageSquare,
      t: "UCaaS Solutions",
      d: "Unified collaboration across Teams, Zoom, Webex & RingCentral.",
    },
    {
      icon: Cloud,
      t: "Salesforce Consulting",
      d: "Service Cloud, Sales Cloud & Industry Cloud implementations.",
    },
    {
      icon: Bot,
      t: "AI & Automation",
      d: "GenAI, agent assist, RPA - automate the next 40% of CX work.",
    },
    {
      icon: Sparkles,
      t: "Conversational AI",
      d: "Lex, Dialogflow CX, Genesys Bot Flows for omnichannel self-service.",
    },
    {
      icon: Network,
      t: "Cloud Architecture",
      d: "Landing zones, multi-region HA & secure-by-design networking.",
    },
    {
      icon: Workflow,
      t: "DevOps & CI/CD",
      d: "Pipelines, IaC and platform engineering for elite delivery teams.",
    },
    {
      icon: Shield,
      t: "Oracle SBC",
      d: "Secure session border controller design, deployment & lifecycle.",
    },
    {
      icon: Cpu,
      t: "Contact Center Migration",
      d: "Avaya / Cisco → Genesys Cloud with zero-downtime cutover.",
    },
    {
      icon: Briefcase,
      t: "Collaboration Platforms",
      d: "Enterprise rollouts of Teams, Zoom, Webex with governance.",
    },
    {
      icon: Star,
      t: "Professional Services",
      d: "Advisory, run, optimize - flexible engagement models.",
    },
  ];
  return (
    <SectionShell
      ...
      title={
        <>
          A complete portfolio for <span className="text-gradient">modern customer experience</span>
          .
        </>
      }
    >
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed max-w-xl">
              From journey design to AI experience orchestration - we deliver the entire Genesys
              Cloud value chain for global enterprises. Certified architects, proven playbooks,
              measurable outcomes.
            </p>
            ...
            <div className="mt-10 flex gap-3">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-aurora text-white font-medium shadow-glow"
              >
              ...
              {[
                {
                  ...
                  x: ["Journey", "AI Agents", "Routing", "Voice/Digital"],
                },
                {
                  t: "Genesys Cloud Platform",
                  x: ["WEM", "Analytics", "Bot Flows", "Integrations"],
                },
                ...
                >
                  <div className="text-[10px] uppercase tracking-widest text-[#1B75FF] font-semibold">
                    {row.t}
                  </div>
                  <div className="mt-3 grid grid-cols-4 gap-2">
                    {row.x.map((b) => (
                      <div
                        key={b}
                        className="text-xs px-2 py-2 rounded-lg bg-white/5 border border-white/10 text-center"
                      >
                        {b}
                      </div>
                    ))}
    ...
    <section id="ai" className="relative py-28 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 text-center">
        ...
        <p className="mt-5 max-w-2xl mx-auto text-muted-foreground">
          From generative agents to real-time speech intelligence - we engineer AI systems that
          actually move enterprise CX metrics.
        </p>
...
export function Industries() {
  ...
  return (
    <SectionShell
      ...
      title={
        <>
          Deep expertise across <span className="text-gradient">regulated, customer-led</span>{" "}
          industries.
        </>
      }
    >
...
export function TechEcosystem() {
  ...
  return (
    <SectionShell
      ...
      title={
        <>
          One <span className="text-gradient">integrated architecture</span>, every leading
          platform.
        </>
      }
    >
...
export function WhyRACube() {
  const items = [
    ...
    {
      t: "Genesys Premier Partner",
      d: "Certified architects across Genesys Cloud, PureConnect & PureCloud.",
    },
  ...
  return (
    <SectionShell
      ...
      title={
        <>
          The partner enterprises pick when{" "}
          <span className="text-gradient">CX is mission-critical</span>.
        </>
      }
    >
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 mt-14">
...
export function CaseStudies() {
  const cs = [
    {
      tag: "Banking",
      t: "Migrated 4,000 agents to Genesys Cloud with zero downtime",
      m: "+32% CSAT · -41% AHT",
    },
    {
      tag: "Healthcare",
      t: "AI-powered triage bot deflecting 65% of inbound calls",
      m: "$4.2M annual savings",
    },
    {
      tag: "Telecom",
      t: "Omnichannel CX platform launched in 9 months",
      m: "+18 NPS · -28% churn",
    },
  ];
  return (
    <SectionShell
      ...
      title={
        <>
          Real outcomes for <span className="text-gradient">Fortune-class</span> enterprises.
        </>
      }
    >
...
export function Careers() {
  const skills = ["Genesys", "CCaaS", "Cloud", "AI / GenAI", "DevOps", "Salesforce"];
        ...
        <div className="relative rounded-3xl overflow-hidden glass-strong p-10 md:p-16 border-gradient">
          ...
          <div className="grid lg:grid-cols-2 gap-12 relative">
            ...
            <div>
              ...
              <h2 className="mt-4 text-4xl md:text-5xl font-semibold tracking-tight">
                Build the future of <span className="text-gradient">enterprise CX</span>.
              </h2>

              <p className="mt-5 text-muted-foreground max-w-lg leading-relaxed">
                Join a team of CX architects, AI engineers and cloud specialists shipping work for
                the world's most demanding enterprises.
              </p>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((s) => (
                  <div key={s} className="px-4 py-2.5 rounded-xl glass font-medium text-sm">
                    {s}
                  </div>
                ))}
              </div>
              ...
              <div className="mt-8 grid grid-cols-3 gap-3 text-center">
                {[
                  ...
                  <div key={a} className="p-4 rounded-xl bg-white/5">
                    <div className="text-sm font-semibold text-gradient">{a}</div>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-5 text-muted-foreground">
            Tell us a little - we'll match you with the right Genesys / CX architect within 24
            hours.
          </p>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      onClick={() =>
                        alert("Thank you - a RACube CX architect will be in touch within 24 hours.")
                      }
...
export function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <div className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[#1B75FF] font-semibold">
      <span className="h-px w-6 bg-[#1B75FF]" />
      {children}
    </div>
  );
}
